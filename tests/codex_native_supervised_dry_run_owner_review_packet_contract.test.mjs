...
const untrackedNewFileDiffCheckCoverageContractImplementationLaneFiles = [
  ...
  "docs/orchestration/replacement_closeout_evidence_consistency_contract.md",
  "schema/orchestration/replacement_closeout_evidence_consistency_contract.schema.json",
  "tests/replacement_closeout_evidence_consistency_contract.test.mjs",
  "tests/fixtures/replacement-closeout-evidence-consistency-contract/valid/complete-closeout-chain.json",
  "tests/fixtures/replacement-closeout-evidence-consistency-contract/invalid/missing-pr12-close-link.json",
  "tests/fixtures/replacement-closeout-evidence-consistency-contract/invalid/branch-deletion-treated-as-default.json",
